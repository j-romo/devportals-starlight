---
title: "Building a Chat Conversation Component for Sanity Studio (iMessage-Style Bubbles)"
description: "How to build interactive chat bubbles with sender names, timestamps, and multiple visual styles as structured content in Sanity CMS"
date: 2026-02-22
authors:
  - name: Joaquin Romo
tags:
...
That's what I built for my [Astro + Sanity blog](https://peanutbutterandjelly.ai). And thanks to [the documentation system I built](/blog/sanity-documentation-driven-components/), it only took 90 minutes from concept to production.
...
Thanks to [my documentation system](/blog/sanity-documentation-driven-components/), here's how the build broke down:
...
3. Register both following the [Component Adding Guide](https://github.com/j-romo/pbnj-blog/blob/main/docs/adding-custom-components-guide.md)
4. Deploy and enjoy!
